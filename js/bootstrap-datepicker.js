		...
		*/
		...
		setHand: function(x, y, roundBy5, dragging){
			...
			if (this[this.currentView] !== value) {
				if (vibrate) { // TODO: && this.options.vibrate) {
		...
		fill: function(){
			...
			html = '<tr>'+
						'<td colspan="7">'+
							...
							'</div>'+
							'<span class="clockpicker-am-pm-block" style="position: absolute; bottom: 0; height: 30px; width: 200px;">'+
							'</span>'+
						'</td>'+
					'</tr>';

			var tplClock = ['<div class="clockpicker-popover">',
							'<div class="arrow"></div>',
			...
			function mousedown(e, space) {
				...
				var movingTimer = setTimeout(function(){
					// TODO: $body.addClass('clockpicker-moving');
				}, 200);
				...
				$doc.off(mouseupEvent).on(mouseupEvent, function(e){
					...
					// TODO: $body.removeClass('clockpicker-moving');
		...
		showMode: function(dir){
			if (dir){
				this.viewMode = Math.max(this.o.minViewMode, Math.min(3, this.viewMode + dir));
			}
			this.picker
				.find('>div')
				.hide()
